                ...
                <article class="article">
                    ...
                    <div class="article-util">
                        <ul class="article-util-list">
                            ...
                            <li>
                                <form class="form-delete" action="/qna/deleteAnswer?questionId=${question.questionId}" method="POST">
                ...
                <div class="qna-comment">
                    <div class="qna-comment-slipp">
                        ...
                        <div class="qna-comment-slipp-articles">
                            <c:forEach items="${answers}" var="answer" varStatus="status">
                                <article class="article" id="answer-${answer.answerId}">
                                    ...
                                    <div class="article-util">
                                        <ul class="article-util-list">
                                            <li>
                                                <a class="link-modify-article" href="/answers/updateForm">수정</a>
                                            </li>
                                            <li>
                            ...
                            <form class="submit-write" method="post" action="/answers/createAnswer">
